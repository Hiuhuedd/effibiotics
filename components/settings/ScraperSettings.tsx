...
const ScraperSettings = ({ settings, settingsError, updateSettings ,isAdmin}:ScraperSettingsProps) => {
   ...
   return (
      ...
      <div className='settings__content styled-scrollbar p-6 text-sm'>
       ...
       { isAdmin&& <div className="settings__section__select mb-5">
         ...
         {isAdmin&&settings.scraper_type === 'none' && (
            <div className="settings__section__input mb-5">
